...
class Event(models.Model):
    ...
    created_by= models.ForeignKey(User, related_name='create', on_delete=models.CASCADE)
    added_by= models.ManyToManyField(User, related_name='added_events')
...
class Category(models.Model):
    ...
    for_events = models.ManyToManyField(Event, related_name='categories')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)